    ...
    const checklistTemplate = [
      {
        ...
        label:'과부하 방지장치',
        method:'정격하중 초과시 경보음과 함께 작동이 정지될 것',
        refImg:'과부하.png'
      },
      {
        key:'mast_section',
        label:'권과방지장치',
        method:'훅이 최상부에 도달하기 전에 경보음과 함께 작동이 정지될 것',
        refImg:'권과.png'
      },
      {
        key:'slewing_ring',
        label:'비상정지장치',
        method:'버튼을 누르면 동력이 차단되고 버튼은 적색의 수동 복귀형일 것',
        refImg:'비상정지.png'
      },
      {
        key:'jib_counterjib',
        label:'선회제한장치',
        method:'선회 각도 초과시 제한장치가 작동하여 선회 동작이 차단될 것 ',
        refImg:'선회.png'
      },
      {
        key:'wire_rope',
        label:'와이어로프',
        method:'와이어로프는 소선파단,마모,킹크 등의 이상이 없이 양호할 것',
        refImg:'와이어.png'
      },
      {
        key:'hook_block',
        label:'훅/시브',
        method:'훅 해지장치는 탈락 등의 이상이 없고, 시브(도르래) 회전이 원활할 것 ',
        refImg:'훅.png'
      },
      {
        key:'safety_devices',
        label:'트롤리/레일',
        method:'트롤리가 횡행하는 레일의 상태는 양호하고 각 부의 이상이 없을 것',
        refImg:'트롤리.png'
      },
      {
        key:'cab_controls',
